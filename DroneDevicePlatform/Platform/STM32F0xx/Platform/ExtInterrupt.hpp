...
#ifndef PLATFORM_STM32F0XX_EXTINTERRUPT_HPP_
#define PLATFORM_STM32F0XX_EXTINTERRUPT_HPP_
...
class ExtInterrupt : public ExtInterruptHandler {
	static constexpr auto numberToIrq()
	{
		switch (Pin::kPin) {
			case 0:
			case 1:
				return NVIC_EXTI0_1_IRQ;
			case 2:
			case 3:
				return NVIC_EXTI2_3_IRQ;
			case 4:
			case 5:
			case 6:
			case 7:
...
#endif // PLATFORM_STM32F0XX_EXTINTERRUPT_HPP_
