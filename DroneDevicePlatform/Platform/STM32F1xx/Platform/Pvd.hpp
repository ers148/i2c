...
#ifndef PLATFORM_STM32F1XX_PVD_HPP_
#define PLATFORM_STM32F1XX_PVD_HPP_
...
class Pvd {
	...
	static constexpr auto kExti{EXTI16};
	static constexpr auto kIrq{NVIC_PVD_IRQ};
...
#endif // PLATFORM_STM32F1XX_PVD_HPP_
