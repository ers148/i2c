...
#ifndef PLATFORM_STM32F1XX_FLASH_HPP_
#define PLATFORM_STM32F1XX_FLASH_HPP_
...
public:
	...
	static bool protect()
	{
		...
		flash_program_option_bytes(reinterpret_cast<uint32_t>(&FLASH_OPTION_BYTE_0), 0x00FF);
		flash_lock();
		return true;
	}
	...
	{
		return (FLASH_OBR & FLASH_OBR_RDPRT_EN) != 0;
	}
...
#endif // PLATFORM_STM32F1XX_FLASH_HPP_
