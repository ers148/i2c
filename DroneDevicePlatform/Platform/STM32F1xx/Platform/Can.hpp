...
#ifndef PLATFORM_STM32F1XX_CAN_HPP_
#define PLATFORM_STM32F1XX_CAN_HPP_
...
protected:
	...
	{
		return number == 1 ? NVIC_USB_LP_CAN_RX0_IRQ : NVIC_CAN2_RX0_IRQ;
	}

	static constexpr uint8_t numberToTxIrq()
	{
		return number == 1 ? NVIC_USB_HP_CAN_TX_IRQ : NVIC_CAN2_TX_IRQ;
	}
...
#endif // PLATFORM_STM32F1XX_CAN_HPP_
