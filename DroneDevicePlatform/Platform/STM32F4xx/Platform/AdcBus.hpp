...
#ifndef PLATFORM_STM32F4XX_ADCBUS_HPP_
#define PLATFORM_STM32F4XX_ADCBUS_HPP_
...
class AdcBus : public AdcBase<number, stream> {
	...
	static_assert(stream != AdcDmaStreamRemap::NonConfigured, "Stream not configured");
...
#endif // PLATFORM_STM32F4XX_ADCBUS_HPP_
