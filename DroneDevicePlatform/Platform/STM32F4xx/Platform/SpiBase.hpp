...
#ifndef PLATFORM_STM32F4XX_SPIBASE_HPP_
#define PLATFORM_STM32F4XX_SPIBASE_HPP_
		...
		switch (number) {
			case 1: {
				return (remap == SpiDmaRemap::Default
					...
					|| remap == SpiDmaRemap::Spi1Rx0Tx5) ? 0 : 2;
			}
			case 2: {
				return 3;
			}
			case 3: {
				return (remap == SpiDmaRemap::Default
					...
					|| remap == SpiDmaRemap::Spi3Rx0Tx7) ? 0 : 2;
			}
		}
	}
	...
	static constexpr unsigned int numberToDmaTxChannel()
	{
		switch (number) {
			case 1: {
				return (remap == SpiDmaRemap::Default
					|| remap == SpiDmaRemap::Spi1Rx0Tx3
					|| remap == SpiDmaRemap::Spi1Rx2Tx3) ? 3 : 5;
			}
			case 2: {
				return 4;
			}
			case 3: {
				return (remap == SpiDmaRemap::Default
					|| remap == SpiDmaRemap::Spi3Rx0Tx5
					|| remap == SpiDmaRemap::Spi3Rx2Tx5) ? 5 : 7;
			}
		}
	}
...
#endif // PLATFORM_STM32F4XX_SPIBASE_HPP_
