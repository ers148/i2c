...
#ifndef PLATFORM_STM32F4XX_EXTINTERRUPT_HPP_
#define PLATFORM_STM32F4XX_EXTINTERRUPT_HPP_
...
public:
		...
		callback{aCallback}
	{
		...
		if (!rcc_is_periph_clock_enabled(RCC_SYSCFG)) {
...
#endif // PLATFORM_STM32F4XX_EXTINTERRUPT_HPP_
